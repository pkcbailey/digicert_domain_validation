...
def set_dcv_txt(domain_id, api_key):
    url = f"https://www.digicert.com/services/v2/domain/{domain_id}/dcv/method"
    headers = {
        'X-DC-DEVKEY': api_key,
        'Content-Type': 'application/json'
    }
    payload = {"dcv_method": "dns-txt-token"}
    
    print(f"Setting domain {domain_id} to dns-txt-token...")
...
if __name__ == "__main__":
    ...
    # finastra.ai ID is 5330778
    set_dcv_txt(5330778, api_key)
